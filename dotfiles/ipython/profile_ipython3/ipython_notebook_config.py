...
#c.NotebookApp.base_project_url = '/qtg'
...
# c.NotebookApp.MongoContentsManager.mongo_database = 'ipython'
...
# 
# Leading and trailing slashes can be omitted, and will automatically be added.
# c.NotebookApp.base_kernel_url = '/qtg'

# The port the notebook server will listen on.
# c.NotebookApp.port = 8598
...
#c.NotebookApp.password = u'sha1:012e9c3450ba:5440169e7b5e8372109f006af5399a10b4510ae3'
...
# The Logging format template
c.IPKernelApp.log_format = '%(asctime)s %(levelname)s:%(message)s'
...
# `profile` option.
c.ProfileDir.location = u'/srv/profiles'
...
c.InlineBackend.rc = {'font.size': 10, 'figure.figsize': (6.0, 4.0), 'figure.facecolor': (1, 1, 1, 0), 'savefig.dpi': 100, 'figure.subplot.bottom': 0.125, 'figure.edgecolor': (1, 1, 1, 0)}
...
# No effect
# c.NotebookManager.notebook_dir = u'/srv/notebooks'
...
# The directory to use for notebooks.
# c.FileNotebookManager.notebook_dir = u'/opt/ipython'
